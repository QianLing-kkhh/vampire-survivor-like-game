...
- `CharacterDamageReactionSkill`: data-driven damage reactions such as shockwave, blink-forward escape, Witch slow-trail zones, and future sanctuary behaviors.
