...
- `CharacterDamageReactionSkill`: data-driven damage reactions such as shockwave, blink-forward escape, Witch slow-trail zones, Priest holy sanctuary, and future defensive behaviors.
...
- `EnemyFlow`: updates enemy movement, removes dead enemies, applies contact damage, handles general PlayerHealth and Endless reward shield absorption, records kills, and triggers player damage reaction.
