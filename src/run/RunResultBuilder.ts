...
export class RunResultBuilder {
  build(context: RunResultBuildContext) {
    ...
    const playtestCsv = PlaytestLog.createCsv({
      ...
      selectedCharacterId: metadata.selectedCharacterId ?? metadata.characterId,
      characterSelectionMode: metadata.characterSelectionMode ?? 'fixed',
      characterId: metadata.characterId,
      selectedStageId: metadata.selectedStageId ?? metadata.stageId,
      ...
      bossDamageDealt: runStatsSummary.bossDamageDealt,
    ...
    return {
      ...
      finalExp,
      score: context.runState.score,
      normalEnemyScore: context.runState.normalEnemyScore,
      miniBossScore: context.runState.miniBossScore,
      finalBossScore: context.runState.finalBossScore,
      treasureScore: context.runState.treasureScore,
      killCount: context.runState.killCount,
      treasureDropCount: context.runState.treasureDropCount,
      treasureOpenCount: context.runState.treasureOpenCount,
      treasureUpgradePath: context.runState.treasureUpgradePath,
